...
- List is supposed to be available on https://www.uoc.cw/domain-registration/cw-registered-domains  but this does not look accurate (in addition to be monthly updated only). For example only 9 domains starting with a number on that web list, vs 273 found by zonewalking.
